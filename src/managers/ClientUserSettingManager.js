...
class ClientUserSettingManager extends BaseManager {
  ...
  _patch(data = {}) {
    ...
    if ('locale' in data) {
      this.locale = typeof localeSetting !== 'undefined' && localeSetting ? localeSetting[data.locale] : data.locale;
    }
    ...
    if ('explicit_content_filter' in data) {
      this.DMScanLevel =
        typeof DMScanLevel !== 'undefined' && DMScanLevel
          ? DMScanLevel[data.explicit_content_filter]
    ...
    if ('animate_stickers' in data) {
      this.stickerAnimationMode =
        typeof stickerAnimationMode !== 'undefined' && stickerAnimationMode
          ? stickerAnimationMode[data.animate_stickers]
          : data.animate_stickers;
    }
    ...
    if ('friend_source_flags' in data) {
      const fsf = data.friend_source_flags || {};

      this.addFriendFrom = {
        all: fsf.all || false,
        mutual_friends: fsf.all ? true : fsf.mutual_friends || false,
        mutual_guilds: fsf.all ? true : fsf.mutual_guilds || false,
      };
    }
